(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))o(t);new MutationObserver(t=>{for(const a of t)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function r(t){const a={};return t.integrity&&(a.integrity=t.integrity),t.referrerPolicy&&(a.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?a.credentials="include":t.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(t){if(t.ep)return;t.ep=!0;const a=r(t);fetch(t.href,a)}})();const f=[{label:"Ana Sayfa",labelEn:"Home",href:"/"},{label:"İnsansız Araçlar",labelEn:"Unmanned Vehicles",href:"/insansiz-araclar.html"},{label:"UMAY",labelEn:"UMAY",href:"/umay.html"},{label:"Kariyer",labelEn:"Careers",href:"/kariyer.html"},{label:"İletişim",labelEn:"Contact",href:"/iletisim.html"}],g="ascalon-lang";function c(){try{return localStorage.getItem(g)==="en"?"en":"tr"}catch{return"tr"}}function m(l){try{localStorage.setItem(g,l==="en"?"en":"tr")}catch{}window.location.reload()}const i=c()==="en",n=(l,e)=>i?e:l;function h(l=document){i&&(document.documentElement.lang="en",l.querySelectorAll("[data-en]").forEach(e=>{e.textContent=e.dataset.en}),l.querySelectorAll("meta[data-en-content]").forEach(e=>{e.setAttribute("content",e.dataset.enContent)}),l.querySelectorAll("[data-lang-tr]").forEach(e=>{e.hidden=!0}),l.querySelectorAll("[data-lang-en]").forEach(e=>{e.hidden=!1}))}function d(l){return f.map(e=>`<li><a class="${l}" href="${e.href}">${i?e.labelEn:e.label}</a></li>`).join("")}function u(l){const e=c();return`
  ...
  `}function p(l){l.innerHTML=`
    <header class="site-header">
      <a href="/" class="brand">
        <img src="/images/logo.png" alt="${n("Ascalon Dynamics logosu","Ascalon Dynamics logo")}" class="brand-logo" />
  ...
  `;const e=l.querySelector(".hamburger"),r=l.querySelector("#mobile-menu");function o(){r.classList.remove("is-open"),e.classList.remove("is-active"),e.setAttribute("aria-expanded","false"),document.body.classList.remove("menu-open")}function t(){const a=r.classList.toggle("is-open");e.classList.toggle("is-active",a),e.setAttribute("aria-expanded",String(a)),document.body.classList.toggle("menu-open",a)}e.addEventListener("click",t),r.querySelectorAll(".mobile-nav-link").forEach(a=>{a.addEventListener("click",o)}),l.querySelectorAll("[data-set-lang]").forEach(a=>{a.addEventListener("click",()=>{const s=a.dataset.setLang;s!==c()&&m(s)})})}const b=[{label:"Gizlilik Politikası",labelEn:"Privacy Policy",href:"#"},{label:"Çerez Politikası",labelEn:"Cookie Policy",href:"#"},{label:"Kullanım Koşulları",labelEn:"Terms of Use",href:"#"},{label:"KVKK Aydınlatma Metni",labelEn:"Personal Data Protection Notice",href:"#"}];function v(l){l.innerHTML=`
    <footer class="site-footer">
      ...
      <div class="footer-bottom">
        ...
        <p>${n("© 2026 Ascalon Dynamics. Tüm hakları saklıdır.","© 2026 Ascalon Dynamics. All rights reserved.")}</p>
      </div>
    </footer>
  `}function y(l=document){const e=l.querySelectorAll(".reveal");if(!e.length)return;if(window.matchMedia("(prefers-reduced-motion: reduce)").matches||!("IntersectionObserver"in window)){e.forEach(t=>t.classList.add("reveal-visible"));return}const o=new IntersectionObserver(t=>{t.forEach(a=>{a.isIntersecting&&(a.target.classList.add("reveal-visible"),o.unobserve(a.target))})},{threshold:.15,rootMargin:"0px 0px -40px 0px"});e.forEach(t=>o.observe(t))}export{v as a,h as b,i as c,y as i,p as r,n as t};
